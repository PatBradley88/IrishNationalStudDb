...
namespace IrishNationalStud.Data.Migrations
{
    ...
    [Migration("20181215113052_FoalsSeedData")]
    partial class FoalsSeedData
    {
            ...
            modelBuilder.Entity("IrishNationalStud.Models.Foals", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Colour = "Chestnut", DOB = new DateTime(2017, 5, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), Dam = "Diamond Sky", Name = " ", Sex = 0, Sire = "Gale Force Ten" }
                    );
                });
