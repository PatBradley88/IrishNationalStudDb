...
namespace IrishNationalStud.Data.Migrations
{
    ...
    [Migration("20181110144104_addStallionMigToMares")]
    partial class addStallionMigToMares
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IrishNationalStud.Models.Mares", b =>
                {
                    ...
                    b.Property<int?>("StallionId");

                    b.Property<int?>("StallionsId");

                    b.HasKey("Id");

                    b.HasIndex("StallionId");

                    b.HasIndex("StallionsId");
            ...
            modelBuilder.Entity("IrishNationalStud.Models.Mares", b =>
                {
                    b.HasOne("IrishNationalStud.Models.Stallions", "Stallion")
                        .WithMany()
                        .HasForeignKey("StallionId");

                    b.HasOne("IrishNationalStud.Models.Stallions", "Stallions")
                        .WithMany()
                        .HasForeignKey("StallionsId");
                });
